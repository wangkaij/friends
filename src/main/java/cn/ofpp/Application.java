...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        GirlFriend girlFriend = new GirlFriend("王欣雨",
                "山东省", "青岛市", "1999-08-08", "2011-04-16", "oHt_453JSfd2lXR6rAB7tPpe4h6w", "QQAjnPKONi83cTNQbHAy2hA9nIP6OYcrTBGIAsyTMc4");
        ...
        BoyFriend boyFriend = new BoyFriend("王欣雨",
                "山东省", "青岛市", "1999-08-08", "2011-04-16", "oHt_453NywxHOAER_upORqs47M2o", "QQAjnPKONi83cTNQbHAy2hA9nIP6OYcrTBGIAsyTMc4");
        Wx.sendTemplateMessage(MessageFactory.resolveMessage(girlFriend));
    }
